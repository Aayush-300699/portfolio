...
const skillsSection = {
  ...
  skills: [
    '⚡ Versatile Full-Stack Developer with over 3 years of experience in designing, developing, and deploying complex web applications, leveraging a Master’s in Computer Applications. ',
    '⚡ Proficient in building scalable and modular architectures using technologies such as Node.js, Angular, and PostgreSQL, ensuring high performance and maintainability.',
    '⚡ Expert in RESTful API development and cloud infrastructure management with AWS, facilitating seamless integration and deployment of applications.',
    '⚡ Skilled in optimizing database performance through advanced SQL query techniques and efficient schema design, resulting in reduced latency and improved user experiences.',
    '⚡ Showcased success in automating business processes through the development of ERP systems and enhancing real-time communication with messaging platforms.',
    '⚡ Showcasing strong command of MEAN Stack and Angular/Node.js technologies, complemented by hands-on experience in deploying high-performance real-time messaging platforms utilizing AWS cloud infrastructure for optimal reliability and efficiency.',
    '⚡ Implemented advanced monitoring and alert systems to track transaction success rates and minimize downtime during banking integrations.',
    '⚡ Designed and implemented secure and efficient banking integration solutions within ERP systems for leading banks, enabling seamless transaction processing and real-time data synchronization.',
    '⚡ Passionate about emerging technologies and best coding practices, committed to delivering secure, maintainable, and efficient code while collaborating effectively in Agile environments.'
  ],
